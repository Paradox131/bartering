        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SwapOffers_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SwapOffers_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SwapOffers_Items_OfferedItemId",
                        column: x => x.OfferedItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SwapOffers_Items_RequestedItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SwapOffers_FromUserId",
                table: "SwapOffers",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SwapOffers_OfferedItemId",
                table: "SwapOffers",
                column: "OfferedItemId");

            migrationBuilder.CreateIndex(
                name: "IX_SwapOffers_RequestedItemId",
                table: "SwapOffers",
                column: "RequestedItemId");

            migrationBuilder.CreateIndex(
                name: "IX_SwapOffers_ToUserId",
                table: "SwapOffers",
                column: "ToUserId");
        }
